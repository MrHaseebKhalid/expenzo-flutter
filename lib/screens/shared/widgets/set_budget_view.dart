...
import "package:expenzo/screens/shared/widgets/sub_category_box.dart";
...
class SetBudgetView extends StatelessWidget {
      ...
      body: Column(
        children: [
          Padding(
            ...
            child: MyAppBar1(titleText: "Set Budget", titleFontSize: 19),
          ),
          Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          simpleText(
                            "Set your first budget to continue to app.",
                          ),
                          getHorSpace(5),
                      ...
                      MyButton(
                        ...
                        onTap: () {
                          Constant.navigateToRoute(context, Routes.welcome);
                        },
                      ),
                      getVerSpace(30),
                    ],
