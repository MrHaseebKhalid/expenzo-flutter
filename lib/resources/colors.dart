...
class AppColors {
  ...
  final Color bgColor = Color(0xFFF4F4F4);
  final Color primaryColor = Color(0xFF0F66EF);
  final Color secondaryColor = Color(0xFF34A853);
  final Color textColor = Color(0xFF0D1B2A);
  final Color dimTextColor = Color(0xFF989898);
